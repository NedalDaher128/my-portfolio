    ...
    return (
        ...
        <div className=" h-full">
            <div  className="flex flex-col justify-center items-center  min-h-[810px] w-full bg-black overflow-hidden ">
                <h1 data-aos="fade-left" className="text-white text-6xl font-body">Nedal Daher</h1>
                <p data-aos="fade-down" className="font-logo cursor-pointer text-[16px] text-white tracking-[5px] md:text-[30px] md:tracking-[11px] ">Bro-I am-Superman!</p>
            </div>
            <div className="flex flex-col gap-16 justify-center items-center min-h-[780px] p-16     ">
                <div data-aos='fade-left' className="flex flex-col gap-5 min-w[650px] max-w-[650px]">
                ...
                <div data-aos='fade-right' className="flex flex-col gap-5 min-w[650px] max-w-[650px]">
